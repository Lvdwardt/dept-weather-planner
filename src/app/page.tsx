...
export default async function Home() {
  ...
  let currentWeather = weatherInfo.find((weather) => {
    if (weather.minTemp && weather.maxTemp) {
      return temp >= weather.minTemp && temp <= weather.maxTemp;
    } else if (weather.minTemp) {
      return temp >= weather.minTemp;
    } else if (weather.maxTemp) {
      return temp <= weather.maxTemp;
    }
  });
  ...
  return (
    <div className="flex flex-col lg:flex-row">
      <div className="min-h-full w-full text-white lg:min-h-screen lg:w-[50vw]">
        ...
        <div className="mt-auto w-full bg-dept-50 px-4 py-6 text-black lg:pl-24 xl:h-[75vh] xl:pl-36 2xl:pl-48">
          <div className="lg:ml-auto lg:max-w-[800px]">
